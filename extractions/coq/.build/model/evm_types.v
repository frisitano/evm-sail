...
refine {|
  encode x := encode (Account_info x, Account_exists x, Account_storage_cleared x, Account_created x, Account_selfdestructed x);
...
Notation "{[ r 'with' 'Account_exists' := e ]}" :=

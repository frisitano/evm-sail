...
/- Type quantifiers: k_ex549870_ : Nat, 0 ≤ k_ex549870_ ∧ k_ex549870_ ≤ (2 ^ 256 - 1) -/
...
/- Type quantifiers: k_ex549871_ : Nat, 0 ≤ k_ex549871_ ∧ k_ex549871_ ≤ (2 ^ 256 - 1) -/
...
/- Type quantifiers: k_ex549872_ : Nat, 0 ≤ k_ex549872_ ∧ k_ex549872_ ≤ (2 ^ 256 - 1) -/
...
/- Type quantifiers: k_ex549873_ : Nat, 0 ≤ k_ex549873_ ∧ k_ex549873_ ≤ (2 ^ 256 - 1) -/
...
/- Type quantifiers: k_ex549880_ : Nat, 0 ≤ k_ex549880_ ∧ k_ex549880_ ≤ 64 -/
...
/- Type quantifiers: _reclimit : Nat, k_ex549916_ : Nat, k_source_off : Nat, k_source_len : Nat, (source_valid_range k_source_off k_source_len), 2
  ≤ k_ex549916_ ∧ k_ex549916_ ≤ 16, 0 ≤ _reclimit -/
    ...
    (do
      ...
      then
        (do
          ...
          let decoded_child ← do (input_field_to_ref child)
...
def decode_input_trie_node (node : (Sigma fun (k_off : Nat) =>
  ...
  then
    ...
    (do
      ...
      let first_child ← do (input_field_to_ref first)
      let second_child ← do (input_field_to_ref second)
...
/- Type quantifiers: k_ex549961_ : Nat, 0 ≤ k_ex549961_ ∧ k_ex549961_ ≤ 64 -/
...
/- Type quantifiers: k_ex549962_ : Nat, 0 ≤ k_ex549962_ ∧ k_ex549962_ ≤ 64 -/
...
/- Type quantifiers: _reclimit : Nat, k_ex549973_ : Nat, node_dependentWitness1 : Nat, node_dependentWitness0
  : Nat, 0 ≤ node_dependentWitness0 ∧
  0 ≤ node_dependentWitness1 ∧
  (node_dependentWitness0 + node_dependentWitness1) ≤ (2 ^ 32 - 1), 0 ≤ k_ex549973_ ∧
  k_ex549973_ ≤ 64, 0 ≤ _reclimit -/
...
/- Type quantifiers: k_ex549987_ : Nat, 0 ≤ k_ex549987_ ∧ k_ex549987_ ≤ (2 ^ 256 - 1) -/
...
/- Type quantifiers: k_ex549988_ : Nat, 0 ≤ k_ex549988_ ∧ k_ex549988_ ≤ (2 ^ 256 - 1) -/
...
/- Type quantifiers: k_ex549989_ : Nat, 0 ≤ k_ex549989_ ∧ k_ex549989_ ≤ (2 ^ 256 - 1) -/
...
/- Type quantifiers: k_ex549991_ : Nat, k_ex549990_ : Nat, 0 ≤ k_ex549990_ ∧

...
/- Type quantifiers: k_ex607599_ : Nat, input_dependentWitness1 : Nat, input_dependentWitness0 : Nat, 0
  ≤ input_dependentWitness0 ∧
  0 ≤ input_dependentWitness1 ∧
  (input_dependentWitness0 + input_dependentWitness1) ≤ (2 ^ 32 - 1), 0 ≤ k_ex607599_ ∧
  k_ex607599_ ≤ (2 ^ 32 - 1) -/

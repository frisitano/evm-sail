...
/- Type quantifiers: k_ex547435_ : Nat, k_ex547434_ : Nat, 0 ≤ k_ex547434_ ∧
  k_ex547434_ ≤ (2 ^ 256 - 1), 0 ≤ k_ex547435_ ∧ k_ex547435_ ≤ (2 ^ 256 - 1) -/
...
/- Type quantifiers: k_ex547437_ : Nat, k_ex547436_ : Nat, 0 ≤ k_ex547436_ ∧
  k_ex547436_ ≤ (2 ^ 256 - 1), 0 ≤ k_ex547437_ ∧ k_ex547437_ ≤ (2 ^ 256 - 1) -/
...
/- Type quantifiers: k_ex547439_ : Nat, k_ex547438_ : Nat, 0 ≤ k_ex547438_ ∧
  k_ex547438_ ≤ (2 ^ 256 - 1), 0 ≤ k_ex547439_ ∧ k_ex547439_ ≤ (2 ^ 256 - 1) -/
...
/- Type quantifiers: k_ex547442_ : Nat, k_ex547441_ : Nat, 0 ≤ k_ex547441_ ∧
  k_ex547441_ ≤ (2 ^ 256 - 1), 0 ≤ k_ex547442_ ∧ k_ex547442_ ≤ 255 -/
...
/- Type quantifiers: k_ex547444_ : Bool -/
...
/- Type quantifiers: k_ex547447_ : Nat, k_ex547446_ : Nat, 0 ≤ k_ex547446_ ∧
  k_ex547446_ ≤ (2 ^ 256 - 1), 0 ≤ k_ex547447_ ∧ k_ex547447_ ≤ 256 -/
...
/- Type quantifiers: k_ex547449_ : Nat, k_ex547448_ : Nat, 0 ≤ k_ex547448_ ∧
  k_ex547448_ ≤ (2 ^ 256 - 1), 0 ≤ k_ex547449_ ∧ k_ex547449_ ≤ 256 -/
...
/- Type quantifiers: k_ex547451_ : Nat, k_ex547450_ : Nat, 0 ≤ k_ex547450_ ∧
  k_ex547450_ ≤ (2 ^ 256 - 1), 0 ≤ k_ex547451_ ∧ k_ex547451_ ≤ 256 -/
...
/- Type quantifiers: k_ex547455_ : Nat, k_ex547454_ : Nat, 0 ≤ k_ex547454_ ∧
  k_ex547454_ ≤ (2 ^ 256 - 1), 0 ≤ k_ex547455_ ∧ k_ex547455_ ≤ (2 ^ 256 - 1) -/
...
/- Type quantifiers: k_ex547458_ : Nat, k_ex547457_ : Nat, 0 ≤ k_ex547457_ ∧
  k_ex547457_ ≤ (2 ^ 256 - 1), 0 ≤ k_ex547458_ ∧ k_ex547458_ ≤ (2 ^ 256 - 1) -/
...
(YP Appendix H). -/
/- Type quantifiers: k_ex547460_ : Nat, k_ex547459_ : Nat, 0 ≤ k_ex547459_ ∧
  k_ex547459_ ≤ (2 ^ 256 - 1), 0 ≤ k_ex547460_ ∧ k_ex547460_ ≤ (2 ^ 256 - 1) -/
def alu_div (a : Nat) (b : Nat) : Nat :=
  (word_div_word a b)

/-- `MOD`: unsigned modulus; a zero modulus yields `0`. -/
/- Type quantifiers: k_ex547462_ : Nat, k_ex547461_ : Nat, 0 ≤ k_ex547461_ ∧
  k_ex547461_ ≤ (2 ^ 256 - 1), 0 ≤ k_ex547462_ ∧ k_ex547462_ ≤ (2 ^ 256 - 1) -/
def alu_mod (a : Nat) (b : Nat) : Nat :=
  (word_mod_word a b)

/-- `SDIV`: signed division, truncating toward zero; division by zero
yields `0`. -/
/- Type quantifiers: k_ex547464_ : Nat, k_ex547463_ : Nat, 0 ≤ k_ex547463_ ∧
  k_ex547463_ ≤ (2 ^ 256 - 1), 0 ≤ k_ex547464_ ∧ k_ex547464_ ≤ (2 ^ 256 - 1) -/
...
yields `0`. -/
/- Type quantifiers: k_ex547466_ : Nat, k_ex547465_ : Nat, 0 ≤ k_ex547465_ ∧
  k_ex547465_ ≤ (2 ^ 256 - 1), 0 ≤ k_ex547466_ ∧ k_ex547466_ ≤ (2 ^ 256 - 1) -/
...
/- Type quantifiers: k_ex547468_ : Nat, k_ex547467_ : Nat, 0 ≤ k_ex547467_ ∧
  k_ex547467_ ≤ (2 ^ 256 - 1), 0 ≤ k_ex547468_ ∧ k_ex547468_ ≤ (2 ^ 256 - 1) -/
...
unchanged. -/
/- Type quantifiers: k_ex547470_ : Nat, k_ex547469_ : Nat, 0 ≤ k_ex547469_ ∧
  k_ex547469_ ≤ (2 ^ 256 - 1), 0 ≤ k_ex547470_ ∧ k_ex547470_ ≤ (2 ^ 256 - 1) -/
...
/- Type quantifiers: k_ex547472_ : Nat, k_ex547471_ : Nat, 0 ≤ k_ex547471_ ∧
  k_ex547471_ ≤ (2 ^ 256 - 1), 0 ≤ k_ex547472_ ∧ k_ex547472_ ≤ (2 ^ 256 - 1) -/
def alu_lt (a : Nat) (b : Nat) : Nat :=
  let result := (word_ult a b)
  (word_of_bool result)

/-- `GT`: `1` when `a` is strictly above `b`, unsigned. -/
/- Type quantifiers: k_ex547474_ : Nat, k_ex547473_ : Nat, 0 ≤ k_ex547473_ ∧
  k_ex547473_ ≤ (2 ^ 256 - 1), 0 ≤ k_ex547474_ ∧ k_ex547474_ ≤ (2 ^ 256 - 1) -/
def alu_gt (a : Nat) (b : Nat) : Nat :=
  let result := (word_ult b a)
  (word_of_bool result)

/-- `SLT`: `1` when `a` is strictly below `b`, two's-complement signed. -/
/- Type quantifiers: k_ex547476_ : Nat, k_ex547475_ : Nat, 0 ≤ k_ex547475_ ∧
  k_ex547475_ ≤ (2 ^ 256 - 1), 0 ≤ k_ex547476_ ∧ k_ex547476_ ≤ (2 ^ 256 - 1) -/
def alu_slt (a : Nat) (b : Nat) : Nat :=
  let result := (word_slt a b)
  (word_of_bool result)

/-- `SGT`: `1` when `a` is strictly above `b`, two's-complement signed. -/
/- Type quantifiers: k_ex547478_ : Nat, k_ex547477_ : Nat, 0 ≤ k_ex547477_ ∧
  k_ex547477_ ≤ (2 ^ 256 - 1), 0 ≤ k_ex547478_ ∧ k_ex547478_ ≤ (2 ^ 256 - 1) -/
def alu_sgt (a : Nat) (b : Nat) : Nat :=
  let result := (word_slt b a)
  (word_of_bool result)

/- Type quantifiers: k_ex547480_ : Nat, k_ex547479_ : Nat, 0 ≤ k_ex547479_ ∧
  k_ex547479_ ≤ (2 ^ 256 - 1), 0 ≤ k_ex547480_ ∧ k_ex547480_ ≤ (2 ^ 256 - 1) -/
...
/- Type quantifiers: k_ex547483_ : Nat, k_ex547482_ : Nat, 0 ≤ k_ex547482_ ∧
  k_ex547482_ ≤ (2 ^ 256 - 1), 0 ≤ k_ex547483_ ∧ k_ex547483_ ≤ (2 ^ 256 - 1) -/
def alu_and (a : Nat) (b : Nat) : Nat :=
  (word_and a b)

/- Type quantifiers: k_ex547485_ : Nat, k_ex547484_ : Nat, 0 ≤ k_ex547484_ ∧
  k_ex547484_ ≤ (2 ^ 256 - 1), 0 ≤ k_ex547485_ ∧ k_ex547485_ ≤ (2 ^ 256 - 1) -/
def alu_or (a : Nat) (b : Nat) : Nat :=
  (word_or a b)

/- Type quantifiers: k_ex547487_ : Nat, k_ex547486_ : Nat, 0 ≤ k_ex547486_ ∧
  k_ex547486_ ≤ (2 ^ 256 - 1), 0 ≤ k_ex547487_ ∧ k_ex547487_ ≤ (2 ^ 256 - 1) -/
...
indices ≥ 32 yield `0`. -/
/- Type quantifiers: k_ex547490_ : Nat, k_ex547489_ : Nat, 0 ≤ k_ex547489_ ∧
  k_ex547489_ ≤ (2 ^ 256 - 1), 0 ≤ k_ex547490_ ∧ k_ex547490_ ≤ (2 ^ 256 - 1) -/
...
/- Type quantifiers: k_ex547492_ : Nat, k_ex547491_ : Nat, 0 ≤ k_ex547491_ ∧
  k_ex547491_ ≤ (2 ^ 256 - 1), 0 ≤ k_ex547492_ ∧ k_ex547492_ ≤ (2 ^ 256 - 1) -/
...
/- Type quantifiers: k_ex547494_ : Nat, k_ex547493_ : Nat, 0 ≤ k_ex547493_ ∧
  k_ex547493_ ≤ (2 ^ 256 - 1), 0 ≤ k_ex547494_ ∧ k_ex547494_ ≤ (2 ^ 256 - 1) -/
...
/- Type quantifiers: k_ex547496_ : Nat, k_ex547495_ : Nat, 0 ≤ k_ex547495_ ∧
  k_ex547495_ ≤ (2 ^ 256 - 1), 0 ≤ k_ex547496_ ∧ k_ex547496_ ≤ (2 ^ 256 - 1) -/

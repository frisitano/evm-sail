/* Generated from sail/kernel/environment.sail. Included by evm.c; do not compile separately. */
    ...
    sail_fixed_bytes_32 z3zE2414;
    {
      ...
      if (z2zE2521) {
        ...
        if (z2zE2522) {
          ...
          have_exception = true;
          COPY(sail_string)(throw_location, "sail/kernel/environment.sail:109.16-109.52");

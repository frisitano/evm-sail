...
uint64_t zslice_byte(struct zByteSliceFields zs, uint64_t zoff)
{
  ...
  zlength = zs.zlen;
  bool z2zE3899;
  z2zE3899 = (zoffset < zlength);
  if (z2zE3899) {  z8zE114 = slice_byte_at(zs, zoff);  } else {  z8zE114 = UINT64_C(0x00);  }
end_function_3722: ;
  return z8zE114;
end_block_exception_3723: ;
...
sail_u256 zslice_load(struct zByteSliceFields zs, uint64_t zoff)
{
  ...
  zlength = zs.zlen;
  bool z2zE3898;
  z2zE3898 = (zoffset < zlength);
  if (z2zE3898) {  z8zE117 = slice_load_word(zs, zoff);  } else {  z8zE117 = zZERO_WORD;  }
end_function_3716: ;
  return z8zE117;
...
sail_u256 zslice_load_word_offset(struct zByteSliceFields zs, sail_u256 zoff)
{
  ...
  zslice_len = zs.zlen;
  bool z2zE3897;
  z2zE3897 = u256_lt_u64(zoff, zslice_len);
  if (z2zE3897) {
    {
      uint64_t z3zE3850;
      z3zE3850 = u256_to_u64(zoff);
      z8zE118 = zslice_load(zs, z3zE3850);
    }
  } else {  z8zE118 = zZERO_WORD;  }
end_function_3714: ;
  return z8zE118;
end_block_exception_3715: ;
...
sail_u256 zslice_load_n(struct zByteSliceFields zs, uint64_t zoff, uint64_t zn)
{
  ...
  zlength = zs.zlen;
  bool z2zE3896;
  z2zE3896 = (zoffset < zlength);
  if (z2zE3896) {  z8zE119 = slice_load_n_word(zs, zoff, zn);  } else {  z8zE119 = zZERO_WORD;  }
end_function_3712: ;
  return z8zE119;
end_block_exception_3713: ;
...
unit zslice_copy(struct zByteSliceFields zs, uint64_t zdst, uint64_t zoff, uint64_t zlen)
{
  ...
  if (z2zE3894) {
    ...
    bool z2zE3895;
    z2zE3895 = (zoffset < zsource_length);
    if (z2zE3895) {  z8zE120 = slice_copy_to_memory(zs, zdst, zoff, zlen);  } else {
      z8zE120 = slice_copy_to_memory(zEMPTY_SLICE, zdst, UINT64_C(0), zlen);
    }
  } else {  z8zE120 = UNIT;  }
end_function_3710: ;
  return z8zE120;
end_block_exception_3711: ;
...
unit zslice_copy_word_offset(struct zByteSliceFields zs, uint64_t zdst, sail_u256 zoff, uint64_t zlen)
{
  ...
  zslice_len = zs.zlen;
  bool z2zE3893;
  z2zE3893 = u256_lt_u64(zoff, zslice_len);
  if (z2zE3893) {
    {
      uint64_t z3zE3851;
      z3zE3851 = u256_to_u64(zoff);
      z8zE121 = zslice_copy(zs, zdst, z3zE3851, zlen);
    }
  } else {  z8zE121 = zslice_copy(zEMPTY_SLICE, zdst, UINT64_C(0), zlen);  }
end_function_3708: ;
  return z8zE121;
end_block_exception_3709: ;

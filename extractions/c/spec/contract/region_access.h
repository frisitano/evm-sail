...
uint64_t memory_slice_byte_at(struct zEvmMemorySliceFields slice, uint64_t index);
uint64_t code_region_byte_at(struct zCodeRegionSliceFields slice, uint64_t index);
uint64_t scratch_slice_byte_at(struct zScratchSliceFields slice, uint64_t index);
uint64_t log_data_slice_byte_at(struct zLogDataSliceFields slice, uint64_t index);
uint64_t output_slice_byte_at(struct zOutputSliceFields slice, uint64_t index);
...
struct zScratchSliceFields scratch_store_stateless_input(uint64_t off,
                                                         struct zStatelessInputSliceFields slice);
struct zScratchSliceFields scratch_store_scratch(uint64_t off, struct zScratchSliceFields slice);
struct zScratchSliceFields scratch_store_log_data(uint64_t off, struct zLogDataSliceFields slice);
struct zScratchSliceFields scratch_store_output(uint64_t off, struct zOutputSliceFields slice);

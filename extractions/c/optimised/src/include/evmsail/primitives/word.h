...
static inline __attribute__((__always_inline__)) uint8_t fixed_lane_byte(const uint64_t *lanes,
                                                                         size_t index)
{
...
fixed_lane_set_byte(uint64_t *lanes, size_t index, uint8_t byte)
{
...
static inline __attribute__((__always_inline__)) uint8_t address_byte(const bytes20 *value,
                                                                      size_t index)
{
  return fixed_lane_byte(value->lanes, index);
}

static inline __attribute__((__always_inline__)) uint8_t hash_byte(const bytes32 *value,
                                                                   size_t index)
{
  return fixed_lane_byte(value->lanes, index);
}

static inline __attribute__((__always_inline__)) bool address_equal(const bytes20 *left,
                                                                    const bytes20 *right)
{
...
fixed_lane_compare(const uint64_t *left, const uint64_t *right, size_t length)
{
...
static inline __attribute__((__always_inline__)) int address_compare(const bytes20 *left,
                                                                     const bytes20 *right)
{
  return fixed_lane_compare(left->lanes, right->lanes, 20);
}

static inline __attribute__((__always_inline__)) bool word_equal(const u256 *left,
                                                                 const u256 *right)
{
...
static inline __attribute__((__always_inline__)) int word_compare(const u256 *left,
                                                                  const u256 *right)
{
...
static inline __attribute__((__always_inline__)) void address_to_be_bytes(uint8_t out[20],
                                                                          bytes20 value)
{
...
static inline __attribute__((__always_inline__)) void hash_to_be_bytes(uint8_t out[32],
                                                                       bytes32 value)
{
  memcpy(out, bytes32_data(&value), 32);
}

static inline __attribute__((__always_inline__)) void sail_word_to_be_words4(uint64_t out[4],
                                                                             u256 value)
{
  out[0] = value.limbs[3];
  out[1] = value.limbs[2];
...
static inline __attribute__((__always_inline__)) void sail_word_to_le_words4(uint64_t out[4],
                                                                             u256 value)
{
  out[0] = value.limbs[0];
  out[1] = value.limbs[1];
...
be_words4_to_sail_word(const uint64_t words[4])
{
...
static inline __attribute__((__always_inline__)) u256
le_words4_to_sail_word(const uint64_t words[4])
{
  u256 result = {{words[0], words[1], words[2], words[3]}};
  return result;
}

static inline __attribute__((__always_inline__)) void sail_word_to_be_bytes(uint8_t out[32],
                                                                            u256 value)
{

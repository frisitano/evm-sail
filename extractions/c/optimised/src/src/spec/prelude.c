...
{
  u256 result_8_12 = !u256_lt(left, right) ? u256_sub(left, right) : u256_of_u320(u320_add(u320_of_u256(u256_sub((u256){{UINT64_C(18446744073709551615), UINT64_C(18446744073709551615), UINT64_C(18446744073709551615), UINT64_C(18446744073709551615)}}, u256_sub(right, left))), u320_of_u64(UINT8_C(1))));
  return result_8_12;
}
...
{
  uint16_t result_8_25;
  if (u256_extract_u64(value, (uint64_t)(UINT64_C(192))) != UINT8_C(0)) {
    uint8_t u64_bit_length_result_2_2432 = u64_bit_length_(u256_extract_u64(value, (uint64_t)(UINT64_C(192))));
    result_8_25 = ((uint16_t)((uint32_t)UINT16_C(192) + (uint32_t)(uint16_t)u64_bit_length_result_2_2432));
  } else if (u256_extract_u64(value, (uint64_t)(UINT64_C(128))) != UINT8_C(0)) {
    uint8_t u64_bit_length_result_2_2434 = u64_bit_length_(u256_extract_u64(value, (uint64_t)(UINT64_C(128))));
    result_8_25 = ((uint16_t)u64_bit_length_result_2_2434 + (uint16_t)UINT8_C(128));
  } else if (u256_extract_u64(value, (uint64_t)(UINT64_C(64))) != UINT8_C(0)) {
    uint8_t u64_bit_length_result_2_2436 = u64_bit_length_(u256_extract_u64(value, (uint64_t)(UINT64_C(64))));
    result_8_25 = ((uint16_t)u64_bit_length_result_2_2436 + (uint16_t)UINT8_C(64));
  } else {
    uint8_t tmp_3_3793 = u64_bit_length_(u256_extract_u64(value, (uint64_t)(UINT64_C(0))));
    result_8_25 = (uint16_t)tmp_3_3793;
  }
  return result_8_25;
}
...
{
  return word_sub_word(WORD_ZERO, value);
}
...
{
  uint64_t word_bit_result_2_2383 = word_bit(a, UINT8_C(255));
  uint64_t word_bit_result_2_2382 = word_bit(b, UINT8_C(255));
  if (word_bit_result_2_2383 == UINT64_C(0x1)) {
    if (word_bit_result_2_2382 == UINT64_C(0x1)) {
      return word_ult(a, b);
    }
    return true;
  }
...
{
  bool divisor_is_zero = word_is_zero(b);
  if (divisor_is_zero) {
    return WORD_ZERO;
  }
...
{
  bool modulus_is_zero = word_is_zero(b);
  if (modulus_is_zero) {
    return WORD_ZERO;
  }
...
u256 alu_sdiv(u256 a, u256 b)
{
  ...
  u256 dividend_magnitude = word_abs(a);
  u256 divisor_magnitude = word_abs(b);
  ...
  bool result_2_2381 = neq_bool((bool)(dividend_sign == UINT64_C(0x1)), (bool)(divisor_sign == UINT64_C(0x1)));
  if (result_2_2381) {
...
u256 alu_smod(u256 a, u256 b)
{
  ...
  u256 dividend_magnitude = word_abs(a);
  u256 modulus_magnitude = word_abs(b);
...
u256 alu_signextend(u256 byte_index, u256 value)
{
  if (u256_lt_u64(byte_index, UINT8_C(32))) {
    ...
    u256 low_mask = word_sub_word(low_mask_end, WORD_ONE);
    if (sign_set) {
...
{
  bool result = word_slt(a, b);
  return word_of_bool(result);
}

u256 alu_sgt(u256 a, u256 b)
{
  bool result = word_slt(b, a);
  return word_of_bool(result);
}
...
u256 alu_byte(u256 i, u256 x)
{
  if (u256_lt_u64(i, UINT8_C(32))) {
    ...
    uint8_t tmp_3_3589 = (uint8_t)result_byte;
    return u256_of_fbits(tmp_3_3589);
  }
  return WORD_ZERO;
}
...
{
  if (u256_lt_u64(shift_amt, UINT16_C(256))) {
    return word_arithmetic_shift_right(v, (uint16_t)u256_to_u64_unchecked(shift_amt));
  }
...
{
  uint16_t result_8_990;
  if (u128_extract_u64(value, (uint64_t)(UINT64_C(64))) != UINT8_C(0)) {
    uint8_t u64_bit_length_result_2_2436 = u64_bit_length_(u128_extract_u64(value, (uint64_t)(UINT64_C(64))));
    result_8_990 = ((uint16_t)u64_bit_length_result_2_2436 + (uint16_t)UINT8_C(64));
  } else {
    uint8_t tmp_3_3889 = u64_bit_length_(u128_extract_u64(value, (uint64_t)(UINT64_C(0))));
    result_8_990 = (uint16_t)tmp_3_3889;
  }
  return result_8_990;
}
...
{
  uint8_t tmp_3_3890 = u64_bit_length_((value >> UINT64_C(0)));
  return (uint16_t)tmp_3_3890;
}

uint16_t word_bit_length_uint8_t_to_uint16_t(uint8_t value)
{
  uint8_t tmp_3_3891 = u64_bit_length_((value >> UINT64_C(0)));
  return (uint16_t)tmp_3_3891;
}

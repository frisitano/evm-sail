...
{
  return word_byte_length(w);
}

uint32_t rlp_materialized_slice_size(uint32_t length_, uint64_t first)
{
  bool tmp_3_3432 = (bool)((length_ == UINT8_C(1)) && ((UINT64_C(1) & (first >> UINT8_C(7))) == UINT64_C(0x0)));
  if (tmp_3_3432) {
    return UINT32_C(1);
  }
...
uint8_t rlp_uint_word_size(u256 w)
{
  ...
  bool tmp_3_3431 = (bool)((len == UINT8_C(1)) && ((UINT64_C(1) & (first >> UINT8_C(7))) == UINT64_C(0x0)));
  if (tmp_3_3431) {
    return UINT8_C(1);
  }
...
{
  uint32_t scratch_reserve_result_2_2179 = scratch_reserve(expected_len);
  return ((struct RlpEncoder){.expected_len = expected_len, .start = scratch_reserve_result_2_2179});
}
...
{
  uint32_t scratch_reserve_result_2_2179 = scratch_reserve_uint8_t_to_uint32_t(expected_len);
  return ((struct RlpEncoder){.expected_len = (uint32_t)expected_len, .start = scratch_reserve_result_2_2179});
}

uint8_t rlp_length_prefix_len_uint16_t_to_uint8_t(uint16_t len)
{
  u256 length_word = rlp_length_word_uint16_t_to_u256(len);
  uint8_t rlp_minimal_word_len_result_2_2222 = rlp_minimal_word_len(length_word);
  return ((uint8_t)((uint32_t)rlp_minimal_word_len_result_2_2222 + (uint32_t)UINT8_C(1)));
}

uint8_t rlp_length_prefix_len_uint32_t_to_uint8_t(uint32_t len)
{
  bool lteq_int_result_2_2221 = (bool)(len <= RLP_SHORT_LENGTH_LIMIT);
  if (lteq_int_result_2_2221) {
    return UINT8_C(1);
  }
...
{
  uint8_t rlp_length_prefix_len_result_2_2207 = rlp_length_prefix_len_uint8_t_to_uint8_t();
  return ((uint8_t)((uint32_t)content_len + (uint32_t)rlp_length_prefix_len_result_2_2207));
}

uint8_t rlp_list_size_uint8_t_to_uint8_t_variant_2(uint8_t content_len)
{
  uint8_t rlp_length_prefix_len_result_2_2207 = rlp_length_prefix_len_uint8_t_to_uint8_t_variant_2(content_len);
  return ((uint8_t)((uint32_t)content_len + (uint32_t)rlp_length_prefix_len_result_2_2207));
}

uint8_t rlp_list_size_uint8_t_to_uint8_t_variant_3(uint8_t content_len)
{
  uint8_t rlp_length_prefix_len_result_2_2207 = rlp_length_prefix_len_uint8_t_to_uint8_t_variant_3(content_len);
  return ((uint8_t)((uint32_t)content_len + (uint32_t)rlp_length_prefix_len_result_2_2207));
}

uint8_t rlp_minimal_word_len_u128_to_uint8_t(u128 w)
{
  return word_byte_length_u128_to_uint8_t(w);
}

uint8_t rlp_minimal_word_len_uint64_t_to_uint8_t(uint64_t w)
{
  return word_byte_length_uint64_t_to_uint8_t(w);
}

uint8_t rlp_minimal_word_len_uint8_t_to_uint8_t(uint8_t w)
{
  return word_byte_length_uint8_t_to_uint8_t(w);
}
...
{
  uint32_t result_8_862;
  if (right <= (UINT32_C(4294967295) - left)) {
    result_8_862 = (uint32_t)((uint64_t)left + (uint64_t)right);
  } else {
    fatal_error(RlpDecode);
  }
  return result_8_862;
...
{
  uint32_t result_8_863;
  if (right <= (UINT32_C(4294967295) - left)) {
    result_8_863 = (uint32_t)((uint64_t)left + (uint64_t)right);
  } else {
    fatal_error(RlpDecode);
  }
  return result_8_863;
...
{
  uint32_t result_8_864;
  if (right <= (UINT32_C(4294967295) - (uint32_t)left)) {
    result_8_864 = (uint32_t)((uint64_t)left + (uint64_t)right);
  } else {
    fatal_error(RlpDecode);
  }
  return result_8_864;
...
{
  bool lteq_int_result_2_2191 = (bool)(content_len <= RLP_SHORT_LENGTH_LIMIT);
  if (lteq_int_result_2_2191) {
    uint64_t rlp_length_byte_native_result_2_2192 = rlp_length_byte_native((uint8_t)content_len);
    scratch_push_byte(((UINT64_C(0xC0) + rlp_length_byte_native_result_2_2192) & UINT64_C(0xFF)));
    return;
  }
  u256 length_word = rlp_length_word_uint16_t_to_u256(content_len);
  uint8_t length_len = rlp_minimal_word_len(length_word);
  uint64_t rlp_length_byte_native_result_2_2194 = rlp_length_byte_native(length_len);
  scratch_push_byte(((UINT64_C(0xF7) + rlp_length_byte_native_result_2_2194) & UINT64_C(0xFF)));
...
{
  uint64_t rlp_length_byte_native_result_2_2192 = rlp_length_byte_native(content_len);
  scratch_push_byte(((UINT64_C(0xC0) + rlp_length_byte_native_result_2_2192) & UINT64_C(0xFF)));
}
...
void rlp_write_string_prefix_uint16_t_uint64_t_to_unit(uint16_t len)
{
  u256 length_word = rlp_length_word_uint16_t_to_u256(len);
  uint8_t length_len = rlp_minimal_word_len(length_word);
  uint64_t rlp_length_byte_native_result_2_2202 = rlp_length_byte_native(length_len);
  scratch_push_byte(((UINT64_C(0xB7) + rlp_length_byte_native_result_2_2202) & UINT64_C(0xFF)));
  scratch_push_word_be(length_word, length_len);
}

void rlp_write_string_prefix_uint32_t_uint64_t_to_unit(uint32_t len, uint64_t first)
{
  bool tmp_3_3429 = (bool)((len == UINT8_C(1)) && ((UINT64_C(1) & (first >> UINT8_C(7))) == UINT64_C(0x0)));
  if (tmp_3_3429) {
    return;
  }
  bool lteq_int_result_2_2199 = (bool)(len <= RLP_SHORT_LENGTH_LIMIT);
  if (lteq_int_result_2_2199) {
    uint64_t rlp_length_byte_native_result_2_2200 = rlp_length_byte_native((uint8_t)len);
    scratch_push_byte(((UINT64_C(0x80) + rlp_length_byte_native_result_2_2200) & UINT64_C(0xFF)));
    return;
  }
  u256 length_word = rlp_length_word_uint32_t_to_u256(len);
  uint8_t length_len = rlp_minimal_word_len(length_word);
...
{
  uint64_t rlp_length_byte_native_result_2_2200 = rlp_length_byte_native(len);
  scratch_push_byte(((UINT64_C(0x80) + rlp_length_byte_native_result_2_2200) & UINT64_C(0xFF)));
}

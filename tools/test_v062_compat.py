...
from v062_compat import expand_execution_requests, reference_validation


def main() -> int:
    legacy_requests = type("LegacyRequests", (), {})()
    legacy_requests.deposits = SszList[
        SszDepositRequest, MAX_DEPOSIT_REQUESTS_PER_PAYLOAD
    ]()

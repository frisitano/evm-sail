...
| Rocq | [`rocq/src/`](https://github.com/frisitano/evm-sail/tree/main/extractions/rocq/src) — the model as Rocq definitions | [`ExternBoundary.v`](https://github.com/frisitano/evm-sail/blob/main/extractions/rocq/contract/ExternBoundary.v) — boundary parameters |

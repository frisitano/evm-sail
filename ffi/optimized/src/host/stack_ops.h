 ...
 * C interpreter, which already operates on the generated by-value U256
...
enum stack_rewrite_status {
  EVMSAIL_STACK_REWRITE_OK = 0,
  EVMSAIL_STACK_REWRITE_UNDERFLOW,
  EVMSAIL_STACK_REWRITE_OVERFLOW,
};

/* Check an instruction stack effect without changing the current frame. */

...
[EVM execution types](evm.md), [journal types](journal.md), and the
[system addresses and topics](system.md) reserved by protocol upgrades.
...
[SSZ collections](ssz.md), the [stateless input](stateless_input.md)
envelope, and the non-normative [instrumentation
scopes](cycle_scopes.md).
